...
namespace Yamen::Graphics {
    ...
    glm::vec4 Material::GetVector(const std::string& name, const glm::vec4& defaultValue) const {
    ...
    glm::mat4 Material::GetMatrix(const std::string& name, const glm::mat4& defaultValue) const {
    ...
    void Material::Bind(GraphicsDevice& device) {
        ...
        // Bind render states
        if (m_BlendState) {
            m_BlendState->Bind(nullptr, 0xFFFFFFFF); // Default blend factor and sample mask
        }
