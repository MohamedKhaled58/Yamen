...
namespace Yamen::Graphics {
    ...
    {
        if (!m_InScene) {
            YAMEN_CORE_WARN("Renderer2D::DrawSprite called outside BeginScene/EndScene");
            return;
        }
        ...
        float rotation)
    {
        ...
        m_SpriteBatch->DrawSprite(m_WhiteTexture.get(), position, size, rotation, color, glm::vec2(0.0f));
    }
