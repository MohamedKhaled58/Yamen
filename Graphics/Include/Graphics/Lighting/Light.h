...
namespace Yamen::Graphics {
    ...
    struct Light {
         ...
         */
        static Light CreatePoint(const glm::vec3& position, const glm::vec3& color, float intensity = 1.0f, float range = 10.0f) {
            Light light;
        ...
        static Light CreateSpot(const glm::vec3& position, const glm::vec3& direction, const glm::vec3& color, 
                               float intensity = 1.0f, float innerAngle = 12.5f, float outerAngle = 17.5f) {
            Light light;
